...
const BADGE_DEFS = {
  ...
  exam_perfect: { name: '만점 급제', icon: 'assets/icons/badge_exam_perfect.png', desc: '기출문제 풀이에서 단 한 문제도 틀리지 않았습니다.' },
  exam_allera: { name: '전 시대를 통달하다', icon: 'assets/icons/badge_exam_allera.png', desc: '아홉 시대 모두 기출문제 풀이를 마쳤습니다.' },
