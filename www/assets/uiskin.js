...
(function(){
  ...
  /* 챕터 메뉴 단추(햄버거)는 원래 z-index 25라, 대화창(26 이상)이 열려 있으면
     그 뒤에 깔려 아예 눌리지 않았다(제보: "챕터 들어가자마자 뜨는 대화창을
     끄고 목록으로 돌아가고 싶은데 메뉴도 못 누르네"). 대화·퀴즈·풀이 중에도
     늘 누를 수 있게, 지도(36)·엔딩(40)·왕조계보(45)보다는 낮게 올린다 —
     그 창들은 메뉴에서 연 것들이라 메뉴가 위로 뚫고 나올 필요는 없다. */
  #menu-btn { z-index:32 !important; }
