...
def main():
    ...
    points = {
        ...
        'markers': [
            ...
            # 강동 6주 — 서희가 993년 소손녕과 담판해 확보한 여섯 고을(흥화진·
            # 용주·통주·철주·귀주·곽주). 모두 평안북도 청천강~압록강 사이에
            # 몰려 있어(귀주=구성, 곽주=정주 곽산, 철주=철산, 용주=용천,
            # 통주=선천, 흥화진=의주 인근) 그 중심께에 점 하나로 찍는다.
            {'id': 'gangdong6ju', 'lonlat': [124.9, 39.85], 'label': '강동 6주'},
            # 동북 9성 — 윤관이 1107년 별무반으로 여진을 몰아내고 쌓은 아홉 성.
            # 정확한 위치·범위는 학계에서도 논쟁 중이라(일부는 두만강 이북까지
            # 봤다고 봄) 교과서가 따르는 통설인 '함흥평야 일대'에 찍는다.
            {'id': 'donbuk9seong', 'lonlat': [127.53, 39.92], 'label': '동북 9성(함흥평야 일대)'},
        ],
    }
